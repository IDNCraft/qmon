...
import type { SettingsItem, SettingsRow } from '@/components/dashboard/SettingsCard'
...
import { buildSettingsRows, SettingsCard } from '@/components/dashboard/SettingsCard'
